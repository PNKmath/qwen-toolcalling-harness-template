...
MODEL_PATH="${QWEN27_4BIT_MODEL_PATH:-$HOME/MLX_Models/Qwen3.6-27B-UD-MLX-4bit}"
SERVED_MODEL_NAME="${QWEN27_4BIT_SERVED_MODEL_NAME:-Qwen3.6-27B-UD-MLX-4bit}"
HOST="${QWEN_HOST:-127.0.0.1}"
PORT="${QWEN27_4BIT_PORT:-8016}"
LOG_DIR="${QWEN_LOG_DIR:-$HOME/.mlx-model-control/logs}"
LOG_FILE="${QWEN27_4BIT_LOG_FILE:-$LOG_DIR/qwen36-27b-4bit-parser${PORT}.log}"
